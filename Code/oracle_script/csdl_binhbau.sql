...
(
    ...
    CHINHANH varchar2(20),
    SOLANBAU NUMBER,
    CONSTRAINT PK_Cutri PRIMARY KEY (MA_CUTRI)
);
...
ALTER TABLE CUTRI
ADD CONSTRAINT FK_CUTRI_THANHVIEN
FOREIGN KEY (MA_CUTRI) REFERENCES THANHVIEN(MA_THANHVIEN);

ALTER TABLE CUTRI
ADD CONSTRAINT FK_Cutri_DonVi
FOREIGN KEY (DONVI) REFERENCES DONVI(MA_DONVI);

ALTER TABLE CUTRI
ADD CONSTRAINT FK_Cutri_ChiNhanh
FOREIGN KEY (CHINHANH) REFERENCES CHINHANH(MA_CHINHANH);
